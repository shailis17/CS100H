...
def litCricFriend(wordList, text):
    ...
    # Three lines of code.
    textList = []
    for word in lowercaseText:
        textList.append(word.strip(string.punctuation))
...
aAnLst = ['a','an']
theLst = ['the']
print("Frequency of \"a\" and \"an\" in The Bells: ", litCricFriend(aAnLst,theBells))
print("Frequency of \"the\" in The Bells: ", litCricFriend(theLst,theBells))
print("Frequency of \"a\" and \"an\" in Canto XII: ", litCricFriend(aAnLst,theBells))
print("Frequency of \"the\" in Canto XII: ", litCricFriend(theLst,theBells))
